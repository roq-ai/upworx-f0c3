  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upworx: Empowering Owners, Recruiters, and Freelancers to seamlessly create, manage, and explore job offers, applications, and contracts. Redefining the world of work."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upworx: Empowering Owners, Recruiters, and Freelancers to seamlessly create, manage, and explore job offers, applications, and contracts. Redefining the world of work.`}
            </Text>
            <Box
